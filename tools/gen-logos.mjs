...
${l.css}
		...
		.pv-switch a { display: grid; place-items: center; min-width: 44px; min-height: 44px; border-radius: 999px; text-decoration: none; font-size: 13px; font-weight: 600; color: var(--color-bg); transition: background-color 160ms var(--ease-out); }
