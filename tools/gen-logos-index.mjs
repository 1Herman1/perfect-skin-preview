...
<body>
	<header>
		...
		<p>Одна и та же главная страница в утверждённой палитре — меняется только логотип в шапке. Строка-дескриптор из знака убрана: остались монограмма и название. Внутри каждого макета справа снизу переключатель: можно прыгать между знаками, не возвращаясь сюда.</p>
	</header>
	<main class="grid">${cards}
	</main>
	<footer>
		Оба варианта — с присланного лок-апа: знак, черта и палитра одинаковые, различается только начертание надписи. Монограмма сейчас набрана шрифтом (Playfair Display), а не векторной отрисовкой заказчика: как только придёт исходник, знак и фавикон заменяются на оригинал.
	</footer>
</body>
</html>
`;
